...
import javax.swing.*;
 ...
 class baskinrobin {
	 baskinrobin(){
	        JFrame frame = new JFrame("Baskin-Robbins Menu");
	        ...
	        JPanel backgroundPanel = new JPanel() {
	            ...
	            protected void paintComponent(Graphics g) {
	                ...
	                ImageIcon backgroundIcon = new ImageIcon("C:\\Users\\HS TRADER\\food app\\BB.gif");
	        ...
	        ArrayList<Item2> cartItems = new ArrayList<>();

	        // Load the images and create labels and buttons
	        String basePath = "/Users/bismaarfat/NetBeansProjects/cravingfood/pics";
	        addItem2(contentPanel, cartItems, basePath + "B1.JPG", "Cotton Candy", 424, 0);
	        addItem2(contentPanel, cartItems, basePath + "B2.JPG", "Chocolate Mousse Royale", 424, 1);
	        addItem2(contentPanel, cartItems, basePath + "B3.JPG", "Double Quarter Pounder Meal", 424, 2);
	        addItem2(contentPanel, cartItems, basePath + "B4.JPG", "Single Scoop Sundae", 424, 3);
	        addItem2(contentPanel, cartItems, basePath + "B5.JPG", "Brownie Ala Mod", 424, 4);
	    ...
	    private static void addItem2(JPanel panel, ArrayList<Item2> cartItems, String imagePath, String label, int price, int gridy) {
	        GridBagConstraints gbc = new GridBagConstraints();
	        ...
	        addToCartButton.addActionListener(new ActionListener() {
	            ...
	            public void actionPerformed(ActionEvent e) {
	                int quantity = Integer.parseInt(quantityLabel.getText());
	                cartItems.add(new Item2(label, price, quantity));
	                showCart2(cartItems);
	            }
	        });
	        ...
	        orderNowButton.setBackground(Color.PINK);
	        ...
	        orderNowButton.addActionListener(new ActionListener() {
	            ...
	            public void actionPerformed(ActionEvent e) {
	                int quantity = Integer.parseInt(quantityLabel.getText());
	                cartItems.add(new Item2(label, price, quantity));
	                int totalBill = calculateTotalBill2(cartItems);
	    ...
	    private static int calculateTotalBill2(ArrayList<Item2> cartItems) {
	        int totalBill = 0;
	    ...
	    private static void showCart2(ArrayList<Item2> cartItems) {
	        ...
	        discardButton.setBackground(Color.PINK);
	    ...
	    static class Item2 {
	        ...
	        public Item2(String label, int price, int quantity) {
	            this.label = label;
	            this.price = price;
