...
import javax.swing.*;
 ...
 class macDonalds {
	 macDonalds(){
	        JFrame frame = new JFrame("McDonald's Menu");
	        ...
	        JPanel backgroundPanel = new JPanel() {
	            ...
	            protected void paintComponent(Graphics g) {
	                ...
	                ImageIcon backgroundIcon = new ImageIcon("C:\\Users\\HS TRADER\\food app\\MB.jpg");
	        ...
	        ArrayList<Item1> cartItems = new ArrayList<>();

	        // Load the images and create labels and buttons
	        String basePath = "/Users/bismaarfat/NetBeansProjects/cravingfood/pics";
	        addItem1(contentPanel, cartItems, basePath + "M1.png", "Nashville Hot Sandwich", 690, 0);
	        addItem1(contentPanel, cartItems, basePath + "M2.png", "Loaded Doner Fries", 950, 1);
	        addItem1(contentPanel, cartItems, basePath + "M3.png", "Southern Chicken Rice Bowl", 990, 2);
	        addItem1(contentPanel, cartItems, basePath + "M4.png", "Smash Beef Single Combo", 1140, 3);
	        addItem1(contentPanel, cartItems, basePath + "M5.png", "Churros", 390, 4);
	    ...
	    private static void addItem1(JPanel panel, ArrayList<Item1> cartItems, String imagePath, String label, int price, int gridy) {
	        GridBagConstraints gbc = new GridBagConstraints();
	        ...
	        textLabel.setForeground(Color.ORANGE); // Change the color to white
	        ...
	        addToCartButton.addActionListener(new ActionListener() {
	            ...
	            public void actionPerformed(ActionEvent e) {
	                int quantity = Integer.parseInt(quantityLabel.getText());
	                cartItems.add(new Item1(label, price, quantity));
	                showCart1(cartItems);
	            }
	        });
	        ...
	        orderNowButton.addActionListener(new ActionListener() {
	            ...
	            public void actionPerformed(ActionEvent e) {
	                int quantity = Integer.parseInt(quantityLabel.getText());
	                cartItems.add(new Item1(label, price, quantity));
	                int totalBill = calculateTotalBill1(cartItems);
	    ...
	    private static int calculateTotalBill1(ArrayList<Item1> cartItems) {
	        int totalBill = 0;
	        for (Item1 item : cartItems) {
	            totalBill += item.getPrice() * item.getQuantity();
	        }
	        return totalBill;
	    }

	    private static void showCart1(ArrayList<Item1> cartItems) {
	    ...
	    static class Item1 {
	        ...
	        public Item1(String label, int price, int quantity) {
	            this.label = label;
	            this.price = price;
