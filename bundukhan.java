...
class bundukhan{
      bundukhan(){
    JFrame frame = new JFrame("Bundu Khan Menu");
    ...
    JPanel backgroundPanel = new JPanel() {
        ...
        protected void paintComponent(Graphics g) {
            ...
            ImageIcon backgroundIcon = new ImageIcon("C:\\Users\\HS TRADER\\food app\\BBA.jpg");
    ...
    addItem5(contentPanel, cartItems, basePath + "K1.jpeg", "Chicken Masala Rice", 1350, 0);
    addItem5(contentPanel, cartItems, basePath + "K3.jpeg", "Mutton Seekh Kabab (4 Pcs)", 6040, 1);
    addItem5(contentPanel, cartItems, basePath + "K2.jpg", "Mutton Karahi", 1720, 2);
    addItem5(contentPanel, cartItems, basePath + "K4.jpg", "Zafrani Mutton Leg", 2180, 3);
    addItem5(contentPanel, cartItems, basePath + "K5.jpeg", "Bundu Khan Special Soup", 760, 4);
...
private static void addItem5(JPanel panel, ArrayList<Item3> cartItems, String imagePath, String label, int price, int gridy) {
    GridBagConstraints gbc = new GridBagConstraints();
    ...
    orderNowButton.addActionListener(new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
            int quantity = Integer.parseInt(quantityLabel.getText());
            cartItems.add(new Item3(label, price, quantity));
            int totalBill = calculateTotalBill5(cartItems);
...
private static int calculateTotalBill5(ArrayList<Item3> cartItems) {
    int totalBill = 0;
...
private static void showCart5(ArrayList<Item3> cartItems) {
