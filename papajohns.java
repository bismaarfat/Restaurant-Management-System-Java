...
class papajohns{
    papajohns(){
    JFrame frame = new JFrame("Papa John's Menu");
    ...
    JPanel backgroundPanel = new JPanel() {
        ...
        protected void paintComponent(Graphics g) {
            ...
            ImageIcon backgroundIcon = new ImageIcon("C:\\Users\\HS TRADER\\food app\\PB.jpg");
    ...
    ArrayList<Item5> cartItems = new ArrayList<>();

    // Load the images and create labels and buttons
    String basePath = "/Users/bismaarfat/NetBeansProjects/cravingfood/pics";
    addItem7(contentPanel, cartItems, basePath + "PP1.jpeg", "Peri Peri Chicken", 1250, 0);
    addItem7(contentPanel, cartItems, basePath + "PP3.jpeg", "American Hot", 1299, 1);
    addItem7(contentPanel, cartItems, basePath + "PP2.jpeg", "Smokey Tikka", 1350, 2);
    addItem7(contentPanel, cartItems, basePath + "PP4.jpeg", "Hot Popper Passion", 1549, 3);
    addItem7(contentPanel, cartItems, basePath + "PP5.jpeg", "Garden Special", 1290, 4);
...
private static void addItem7(JPanel panel, ArrayList<Item5> cartItems, String imagePath, String label, int price, int gridy) {
    GridBagConstraints gbc = new GridBagConstraints();
    ...
    addToCartButton.addActionListener(new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
            int quantity = Integer.parseInt(quantityLabel.getText());
            cartItems.add(new Item5(label, price, quantity));
            showCart7(cartItems);
        }
    });
    ...
    orderNowButton.addActionListener(new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
            int quantity = Integer.parseInt(quantityLabel.getText());
            cartItems.add(new Item5(label, price, quantity));
            int totalBill = calculateTotalBill9(cartItems);
...
private static int calculateTotalBill9(ArrayList<Item5> cartItems) {
    int totalBill = 0;
    for (Item5 item : cartItems) {
        totalBill += item.getPrice() * item.getQuantity();
    }
    return totalBill;
}

private static void showCart7(ArrayList<Item5> cartItems) {
...
static class Item5 {
    ...
    public Item5(String label, int price, int quantity) {
        this.label = label;
        this.price = price;
