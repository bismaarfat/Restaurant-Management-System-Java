...
public F4(){
        JFrame frame = new JFrame("Daily deal Menu");
        ...
        JPanel backgroundPanel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                ImageIcon backgroundIcon = new ImageIcon("C:\\Users\\HS TRADER\\food app\\DEB.GIF");
        ...
        ArrayList<Item6> cartItems = new ArrayList<>();

        // Load the images and create labels and buttons
        String basePath = "/Users/bismaarfat/NetBeansProjects/cravingfood/pics";
        addItem6(contentPanel, cartItems, basePath + "DE1.png", "Family Festival 3", 2490, 0);
        addItem6(contentPanel, cartItems, basePath + "DE2.png", "Happy meal", 6040, 1);
        addItem6(contentPanel, cartItems, basePath + "DE3.png", "4 McFlurry Caramel Brownie", 1720, 2);
        addItem6(contentPanel, cartItems, basePath + "DE4.png", "5 Cheesy Mayo", 1280, 3);
        addItem6(contentPanel, cartItems, basePath + "DE5.png", "Bundu Khan Special Soup", 1760, 4);
    ...
    private void addItem6(JPanel panel, ArrayList<Item6> cartItems, String imagePath, String label, int price, int gridy) {
        GridBagConstraints gbc = new GridBagConstraints();
        ...
        textLabel.setForeground(Color.BLACK); // Change the color to black
        ...
        addToCartButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                int quantity = Integer.parseInt(quantityLabel.getText());
                cartItems.add(new Item6(label, price, quantity));
                showCart6(cartItems);
            }
        });
        ...
        orderNowButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int quantity = Integer.parseInt(quantityLabel.getText());
                cartItems.add(new Item6(label, price, quantity));
                int totalBill = calculateTotalBill3(cartItems);
    ...
    private static int calculateTotalBill3(ArrayList<Item6> cartItems) {
        int totalBill = 0;
        for (Item6 item : cartItems) {
            totalBill += item.getPrice() * item.getQuantity();
        }
        return totalBill;
    }

    private void showCart6(ArrayList<Item6> cartItems) {
        JFrame cartFrame = new JFrame("Your Cart");
        cartFrame.setSize(500, 500);
        cartFrame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        ImageIcon iconn = new ImageIcon("C:\\Users\\HS TRADER\\food app\\project.jpg\\project.jpg");
        ...
        orderNowButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                // Simulate the order process
            	 int totalBill = calculateTotalBill3(cartItems);
                 JOptionPane.showMessageDialog(cartFrame, "Total Bill: Rs " + totalBill, "Order Confirmation", JOptionPane.INFORMATION_MESSAGE);
    ...
    static class Item6 {
        ...
        public Item6(String label, int price, int quantity) {
            this.label = label;
            this.price = price;
